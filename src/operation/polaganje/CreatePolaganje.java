 ...
 * @author Vuk
 */
public class CreatePolaganje extends AbstractGenericOperation{
    ...
    protected void executeOperation(Object param) throws Exception {
        polaganje = (Polaganje) repository.create((Polaganje)param);
    }
    
    public Polaganje getCreatedPolaganje(){
        return polaganje;
    }
}
